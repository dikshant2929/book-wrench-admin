	...
	return (
		<>
			<div className='images__wrapper pt-7'>
				...
				<div className='image__inner flex flex-wrap gap-4 mb-3'>
					...
					{list.map((item, key) => <div key={key} className='img__thumbnail flex flex-wrap gap-3 relative'>
						...
						{!props.disabled && <div className='absolute right-0 p-1 rounded-2xl bg-[#80808038]'>
			...
			{isFileUploaderVisible && !props.disabled && <div className='pb-7 border-b-2 border-gray-100'>
				<FileUpload disabled={props.disabled} supportType="jpeg,jpg,png" acceptType="image/png, image/jpeg" parentClass='file_upload' imageURL="" title="" imagePath={onTextChange} />
			</div>}
		</>
	);
};
