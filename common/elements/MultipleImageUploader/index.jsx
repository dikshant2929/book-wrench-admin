	...
	return (
		<>
			<div className='video__wrapper'>
				...
				<div className='image__wrapper flex flex-wrap gap-4 pb-7 border-b-2 border-gray-100'>

					{list.map((item, key) => <div key={key} className='img__thumbnail flex flex-wrap gap-3 relative'>
						<span className='bg-[#DFE2E9] rounded-lg'><img className='w-24 h-24' src={item} alt={item} /></span>
