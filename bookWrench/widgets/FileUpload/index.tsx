    ...
    return (<>
        {
            selectedFile
                ?
                <div className='uploaded__file flex items-center mt-6 border rounded-lg p-4 h-20 relative bg-[#E4E6F1] w-full md:w-auto '>
                    ...
                    { imageUploadStatus && imageURL && <div onClick={onCrossDeleteImage} className={`${props.disabled ? "cursor-not-allowed" : ""} edited__image w-20`}>
                        <img className='w-8 h-8 mx-auto' src={imageURL}></img>
                         {!props.disabled && <span className='absolute top-1 right-1 hover:bg-red-200 hover:fill-[#DE350B]'>
                             <svg height="18" width="18" viewBox="0 0 20 20" aria-hidden="true" focusable="false" className="">
