...
const User = (props) => {
    ...
    const tableCellView = ({ column, data }) => {
        switch (column.key) {
            ...
            case 'isActive':
                const { isVerified, name, password, phoneNumber, role } = data;
                const onChange = (key) => ({ value }) => updateStatus(key, { isVerified, name, password, phoneNumber, role, isActive: value });
    ...
    return (
        <div className="category md:mx-20 mt-11 mb-6">
            ...
            <div className='user__summary grid grid-cols-3 gap-5 mb-6'>
                <div className='t_sr bg-white py-4 px-6 rounded-lg grid gap-2'>
                    <span className='font-normal text-base text-[#656565]'>Total Users</span>
