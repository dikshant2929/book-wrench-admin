        ...
        return (
            <div className="bg-[#F2F3F7] rounded-lg POC relative flex flex-col p-2 gap-1.5">
                ...
                <div className='absolute top-0 right-0 flex gap-1 items-center p-2'>
                    <span className=' border-[#a4a4a4] p-px cursor-pointer' onClick={() => editPointOfContact(itemNumber)}>
                    ...
                    <span className='cursor-pointer' onClick={() => onRemoveContactPerson(customerData.id, contactPersonId, name)}>
