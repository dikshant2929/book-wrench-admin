                        ...
                        <div className="flex flex-col lg:flex-row file_upload_wrapper lg:items-start category__header m-10 gap-4">
                            ...
                            <div className='flex-col w-full md:w-1/2'>
                                ...
                                <div className='flex gap-4 mt-5'>
                                    ...
                                    <Textarea parentClass="textArea w-1/2 ta__with-height" value={fieldValue?.warrentyDescription} onChange={onTextChange('warrentyDescription')} title="Warranty Description" name="serviceDescription" />
                                </div>
                            </div>
